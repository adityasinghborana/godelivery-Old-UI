          ...
          body: SafeArea(
            ...
            children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Image.asset(Images.icCallPharmacy,
                              height: 15, width: 15),
                          Text(
                            "call_me".tr.toUpperCase(),
                            style: robotoRegular.copyWith(
                                fontSize: 10,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            "upload_prescription".tr.toUpperCase(),
                            style: robotoRegular.copyWith(
                                fontSize: 12,
                                fontWeight: FontWeight.w400,
              ...
              Container(
                ...
                decoration:
                    BoxDecoration(border: Border.all(color: Color(0xff9a9a9a))),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Image.asset(Images.icAttechButton, height: 21, width: 19),
                    SizedBox(width: 20),
                    Container(
                      height: 27,
                      width: 1,
                    ...
                    Image.asset(Images.icSendButton, height: 36, width: 36),
                  ],
                ),
              )
            ],

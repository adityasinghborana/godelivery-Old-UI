...
class AuthRepo {
  ...
  Future<void> saveFNameAndLName(String fName, String lName) async {
    try {
      await sharedPreferences.setString(AppConstants.USER_FNAME, fName);
      await sharedPreferences.setString(AppConstants.USER_LNAME, lName);
    } catch (e) {
      throw e;
    }
  }
